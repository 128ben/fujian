...
export function visitorLogin(data) {
    return service({
        url: '/api/main/visitorLogin.json',
        method: 'post',
        data
    })
}
...
// 充值记录
export function rechargeLogApi(data) {
    return service({
        url: '/api/main/rechargeLog.json',
        method: 'get',
        params: data
    })
}
// 提现记录
export function withdrawLogApi(data) {
    return service({
        url: '/api/main/withdrawLog.json',
        method: 'get',
        params: data
    })
}
